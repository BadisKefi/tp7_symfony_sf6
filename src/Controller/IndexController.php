 ...
 * Method({"GET", "POST"})
 */
public function articlesParCategorie(Request $request, ManagerRegistry $doctirine) {
    $entityManager = $doctirine->getManager();
 ...
 * Method({"GET"})
 */
 public function articlesParPrix(Request $request, ManagerRegistry $doctirine)
 {
    $entityManager = $doctirine->getManager();
 ...
 $articles= $doctirine->getRepository(Article::class)->findByPriceRange($minPrice,$maxPrice);
 }
